...
const BookingsPage = ({onBack}) => {const[tab,sT]=useState("upcoming");const list=BOOK.filter(b=>tab==="upcoming"?b.st==="upcoming":b.st!=="upcoming");return<Shell title="Bookings" onBack={onBack}>
